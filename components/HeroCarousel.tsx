    ...
    <section className="relative w-full h-screen bg-background overflow-hidden group">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
        <div className="text-center max-w-3xl mx-auto px-4 animate-fade-in">
          ...
          <Link
            href="/products"
            className="inline-block bg-foreground text-background px-8 md:px-12 py-3 md:py-4 font-semibold hover:bg-accent hover:text-white transition-all duration-300 rounded-lg hover:shadow-lg hover:scale-105"
          >
            Shop Collection
          </Link>
        </div>
